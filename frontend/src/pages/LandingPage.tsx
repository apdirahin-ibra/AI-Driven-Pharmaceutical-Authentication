              ...
              <CardContent className="grid gap-8 p-8 lg:grid-cols-[0.85fr_1.15fr_0.9fr] lg:p-10">
                <div>
                  ...
                  <p className="mt-4 text-base leading-7 text-muted-foreground">
                    An improved convolutional neural network was selected for the PharmaGuard AI prototype based on its performance in identifying learned visual patterns in pharmaceutical package images.
                  </p>
